...
export default function ValuationForm() {
    ...
    if (step === "loading") {
        return (
            <div className="py-12 text-center">
                ...
                <p className="text-lg text-slate-600">Analyzing property details...</p>
            </div>
        );
    }
    ...
    if (step === "result") {
        ...
        return (
            <div className="max-w-2xl mx-auto bg-white p-8 rounded-xl shadow-lg border border-slate-100 text-center">
                ...
                {isReview ? (
                    ...
                    <div className="mb-8 p-8 bg-green-50 rounded-xl border border-green-100">
                        ...
                        <div className="text-4xl md:text-5xl font-extrabold text-slate-900 text-green-800">
    ...
    return (
        <form onSubmit={handleSubmit} className="max-w-2xl mx-auto bg-white p-8 rounded-xl shadow-sm border border-slate-200">

            {/* Disclaimer Block */}
            <div className="bg-slate-50 p-4 rounded-md mb-8 text-sm text-slate-600 border-l-4 border-blue-400">
            ...
            <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        <label className="block text-sm font-medium text-slate-700 mb-1">Sq. Footage (Optional)</label>
                        <input
                            name="sqft"
                            type="number"
                            value={formData.sqft}
                ...
                <div className="border-t pt-6 border-slate-200">
                    ...
                    <p className="text-sm text-slate-500 mb-4">Where should we send your official report?</p>
                    ...
                    <div>
                        <label className="block text-sm font-medium text-slate-700 mb-1">How soon are you selling?</label>
                        <select
                            name="timeframe"
                ...
                <button
                    type="submit"
                    className="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-4 rounded-lg transition-colors shadow-md text-lg mt-4"
                >
                    Get My Estimate
                </button>
            </div>
