          ...
          <Container>
            <div className="pt-2 pb-4 space-y-1">
              ...
              <div className="pt-4 mt-4 border-t border-stone-200 space-y-3">
                <Link href="/home-search" className="flex items-center justify-center gap-2 w-full px-4 py-3 rounded-md font-medium text-stone-700 border border-stone-300 hover:border-stone-400" onClick={() => setIsMenuOpen(false)}>
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
                  </svg>
                  Search Homes
